...
Use template from `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
