...
- **Global scope**: `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/notes/`)
...
2. Glob `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/notes/` — works in any directory
