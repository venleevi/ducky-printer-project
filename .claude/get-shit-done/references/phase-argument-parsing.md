...
```bash
PHASE_INFO=$(node "/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/lveneranta/NO_BACKUP/ducky-printer-project/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
